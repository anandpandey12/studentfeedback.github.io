...
<body>
    ...
    <nav class="navbar navbar-default navbar-fixed-top" role="navigation" style="background:#66CCFF">
        <div class="container" >
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.php" style="color:#FFFFFF">Student feedback Management System</a>
	...
	<li class="dropdown">
        ...
        <ul class="dropdown-menu">
          ...
          <li><a href="index.php?info=HOD_login">HOD</a></li> 
        </ul>
      </li> 
...
<!-- slider -->			
    ...
    <div class="container">
        ...
        <div class="row">
			...
			<div class="col-sm-10" style="margin-top:60px;margin-bottom:80px">
				<h2>About Student feedback Management System</h2>
				We are developing Student Feedback System to provide feedback in an easy and quick manner to the college HOD. So we call it as Student Feedback System which delivers via student staff interface as online system which acting as Service Provider. By using this technology we can provide fast feedback about the college lecturers by student on time to the head of departments as they referred in online system. This project has four kinds of module student, staff, HOD and admin. The student can give feedback to their respective lecturers. This feedback report is checked by their Head of Department. He can view grade obtained by the lecturers and give this report to the principal for further counseling to the college staff
	...
	<div class="navbar-fixed-bottom nav navbar-inverse text-center" style="padding:15px;height:40px; background:#66CCFF">
		<span style="color:#FFFFFF">Developed By ....... 	<a href="http://www.instagram.com/_anand__pandey">Anand Pandey</a>
		 </span>
	</div>
    <!-- jQuery -->
