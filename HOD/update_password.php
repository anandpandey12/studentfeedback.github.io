...
$sql=mysqli_query($conn,"select * from HOD where password='$op' and email='".$_SESSION['HOD_login']."'");
...
if($r==true)
{
	...
	if($np==$cp)
	{
	$sql=mysqli_query($conn,"update HOD set password='$np' where email='".$_SESSION['HOD_login']."'");
