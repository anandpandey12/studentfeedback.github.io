    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="dashboard.php">Student Feedback Management System</a>
            </div>
            <!-- /.navbar-header -->
            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            <a href="#"><i class="fa fa-user fa-fw"></i>HOD<span class="fa arrow"></span></a>
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="dashboard.php?info=add_HOD"><i class="fa fa-plus fa-fw"></i> ADD HOD</a>
                                </li>
                                 <li>
                                    <a href="dashboard.php?info=show_HOD"><i class="fa fa-eye"></i> Manage HOD</a>
                                </li>                           
                            </ul>
                            <!-- /.nav-second-level -->
                        </li
                ...
                <div class="col-lg-12">
                	...
                	<?php 
								...
								if($info!="")
								{
                                    ...
                                    elseif($info=="show_HOD")
                                        {
                                            include('show_HOD.php');
                                        }
